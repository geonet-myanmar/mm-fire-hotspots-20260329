...
[![GitHub Pages](https://img.shields.io/badge/Live_Demo-GitHub_Pages-ff4d1c?style=for-the-badge&logo=github)](https://YOUR_USERNAME.github.io/myanmar-fire-hotspots/)
...
👉 **[View the live dashboard →](https://YOUR_USERNAME.github.io/myanmar-fire-hotspots/)**
...
git clone https://github.com/YOUR_USERNAME/myanmar-fire-hotspots.git
cd myanmar-fire-hotspots
...
git remote add origin https://github.com/YOUR_USERNAME/myanmar-fire-hotspots.git
git branch -M main
...
```
https://YOUR_USERNAME.github.io/myanmar-fire-hotspots/
```
...
> Add screenshots to the `screenshots/` directory after deployment.

| View | Description |
|------|-------------|
| `dashboard-overview.png` | Full dashboard with all panels visible |
| `popup-detail.png` | Hotspot popup showing detailed attributes |
| `heatmap-view.png` | Heatmap overlay highlighting fire density |
